            ...
            ?>
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="nuptk" class="form-control" placeholder="Masukkan NIP">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <?php
                          echo form_dropdown('gender', array('Pilih Jenis Kelamin', 'L'=>'Laki-laki', 'P'=>'Perempuan'), null, "class='form-control'");
                        ?>
                      </div>
                  </div>
